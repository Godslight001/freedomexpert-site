...
return [
    ...
    'smtp_username' => getenv('FREEDOM_SMTP_USERNAME') ?: 'admin@freedomexpert.ca',
    'smtp_password' => getenv('FREEDOM_SMTP_PASSWORD') ?: 'January23rd@2025',
    'from_email' => getenv('FREEDOM_FROM_EMAIL') ?: 'admin@freedomexpert.ca',
    'from_name' => getenv('FREEDOM_FROM_NAME') ?: 'FreedomExpert Website',
    'recipient_email' => getenv('FREEDOM_RECIPIENT_EMAIL') ?: 'admin@freedomexpert.ca',
